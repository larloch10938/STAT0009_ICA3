...
When $n$ is large, by using the law of large numbers, we can also compute the average probability of a jump from one state to the other. By combining this we can find an empiric definition of $M$.
