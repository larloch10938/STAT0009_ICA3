...
#replicate to create multiple points - this bit doesn't run bc of the if statement
re <- replicate(rpois(1,2*pi),point())

#plot points to get upper half circle, this is Gamma
plot(re[1,], re[2,], xlim=c(-1.1,1.1), ylim=c(-0.1,1.1))

#plot to get projection onto x axis, this is Upsilon
plot(re[1,],rep(0,length(re[1,])))
